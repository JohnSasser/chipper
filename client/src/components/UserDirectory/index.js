...
function UserDirectory() {
    ...
    return (
        <div className="main-directory">
            ...
            <div id="box">
                <Link className="nav-link rounded-pill"  to="/userFeed">Feed</Link>
                <Link className="nav-link rounded-pill"  to="/home">Profile</Link>
                <Link className="nav-link rounded-pill"  to="/userPetsProfile">Pet Profile</Link>
                <Link className="nav-link rounded-pill"  to="/">Logout</Link>
            </div> 
            </ul>
        </div>
    )
